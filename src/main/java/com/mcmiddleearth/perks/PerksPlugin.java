...
public class PerksPlugin extends JavaPlugin {
    ...
    public void onEnable(){
        ...
        PerkManager.addPerk(new EquipmentPerk("dwarf_hat"));
        PerkManager.addPerk(new EquipmentPerk("dunadan_hat"));
        PerkManager.addPerk(new EquipmentPerk("elf_king_hat"));
        PerkManager.addPerk(new EquipmentPerk("istar_hat"));
        PerkManager.addPerk(new EquipmentPerk("eye_hat"));
